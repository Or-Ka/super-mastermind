...
/**
 * חלונית „ניתוח מצב המשחק” — מתרגמת את AnalysisResult
 * להודעות הסבר פשוטות בעברית. משותפת למשחק הרגיל ולמצבי החידות.
 */
        ...
        <>
          ...
          {!analysis.consistent ? (
            ...
            <p className="analysis__line">
              {analysis.estimated
                ? 'הנתונים נראים עקביים (בדיקה מדגמית).'
          ...
          <p className="analysis__line">
            ...
            {analysis.solvableInRemaining === 'unknown' &&
              'לא ניתן להבטיח פתרון בניסיונות שנותרו — תלוי באיכות הניחושים.'}
